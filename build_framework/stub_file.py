...
This file is part of the **python-openzwave**
...
def _build_class(class_name, cls, indent):
    if not cls.__module__.startswith('libopenzwave'):
        return ''
...
class build_bootstrap(Command):
    description = 'libopenzwave.py bootstrap builder'
    ...
    def run(self):
        ...
        bootstrap = os.path.join(build_path, 'libopenzwave.py')
